...
if __name__ == '__main__':
    ...
    env = SubprocVecEnv([resume_env(plot=False, dump_CL=True, dump_debug=10, n_env=i) for i in range(number_servers)], start_method='spawn')
    ...
    model.learn(50000, callback=[checkpoint_callback], log_interval=1)
