...
def resume_env(plot=False,  # To plot results (Field, controls, lift, drag, rec area) during training
               ...
               n_env=1,
               simulation_duration = 50, # In non-dimensional time unit
               sim_log_name = "Sim"
               ):
    ...
    optimization_params = {"num_steps_in_pressure_history": 1,
                            ...
                            "min_value_jet_MFR": -1,  # Set min and max Q* for weak actuation
                            "max_value_jet_MFR": 1,
    ...
    env_2d_cylinder = TimeLimit(Env2DCylinderModified(path_root=root,
                                                ...
                                                simu_name=simu_name,
                                                sim_log_name=sim_log_name), max_episode_steps = horizon)
...
#     simulation_duration = 50  # In non-dimensional time unit #add this in the single_runner
#     dt = 0.004
#     single_input = False
#     single_output = False
#     include_actions = True

#     root = '../cyl/mesh/turek_2d'  # Root of geometry file path
#     if (not os.path.exists('mesh')):
#         os.mkdir('mesh')
...
#     probe_distribution = {'distribution_type': 'base',#'mesh_grid_points', # Or 'inflow64' for probes in the wake
#                             'probes_at_jets': False,
#                             # Whether to use probes at jets or not, usually not in use
#                             'n_base': 64}  # Number of probes at cylinder base if 'base' distribution is used
...
#     # env_2d_cylinder = Env2DCylinderModified(path_root=root,
#     #                                         geometry_params=geometry_params,
#     #                                         flow_params=flow_params,
#     #                                         solver_params=solver_params,
#     #                                         output_params=output_params,
